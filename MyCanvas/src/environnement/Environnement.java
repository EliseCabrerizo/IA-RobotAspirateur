...
public class Environnement {
	...
	public void Generation() // génère aléatoirement de la poussière et des bijoux sur une case
								// aléatoire.
	{
	...
	public int calculScore(int energie, int bijoux) {
		// score = 15*bijoux _attrapé + 10*poussière_aspi - 20*bijoux_abs -
		// 5*poussière_rest - energie
		this.setScore(Math.abs(bijoux) * 15 + this.getScore() - (20 * this.getBijoux_Abs())
				- (5 * this.getPoussiere_rest()) - Math.abs(energie));
